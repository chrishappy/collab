...
/**
 * Displays the user chat <not implemented> notifications
 *
...
public class Chat extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
            ...
            r.addValueEventListener(
                new ValueEventListener() {
                  ...
                  public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    // setTitle(String.format(getString(R.string.activity__dynamic_chat_with_title),
                    // toMessageName));
                  }
    ...
    reference =
        FirebaseDatabase.getInstance().getReference("node__user").child(currentUser.getUid());
    reference.addValueEventListener(
        new ValueEventListener() {
          @Override
  ...
  private void sendNotification(String receiver, String username, String message) {
    ...
    //          Data data = new
    // Data(currentUser.getUid(),R.mipmap.ic_launcher,username+":"+message,"new
    // message",toMessageID);
    //
