...
public class userProfile extends AppCompatActivity {
  ...
  public void changeName(View view){
    ...
    FirebaseDatabase.getInstance().getReference().child("node__user").child(currentUser.getUid()).child("name").setValue(name).addOnSuccessListener(new OnSuccessListener<Void>() {
      @Override
    ...
    passwordResetDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int which) {
        ...
        fAuth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
          @Override
          public void onSuccess(Void aVoid) {
            Toast.makeText(userProfile.this, "Resent link sent to email", Toast.LENGTH_SHORT).show();
          }
